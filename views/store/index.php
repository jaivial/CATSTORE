                ...
                <div class="store-sort">
                    ...
                    <select id="sort-select" class="form-control">
                        <option value="fecha_anyadido-DESC"
                            <?php echo ($params['orderBy'] === 'fecha_anyadido' && $params['orderDir'] === 'DESC') ? 'selected' : ''; ?>>
                            Más recientes</option>
                        <option value="fecha_anyadido-ASC"
                            <?php echo ($params['orderBy'] === 'fecha_anyadido' && $params['orderDir'] === 'ASC') ? 'selected' : ''; ?>>
                            Más antiguos</option>
                        <option value="precio-ASC"
                            <?php echo ($params['orderBy'] === 'precio' && $params['orderDir'] === 'ASC') ? 'selected' : ''; ?>>
                            Precio: menor a mayor</option>
                        <option value="precio-DESC"
                            <?php echo ($params['orderBy'] === 'precio' && $params['orderDir'] === 'DESC') ? 'selected' : ''; ?>>
                            Precio: mayor a menor</option>
                        <option value="nombre-ASC"
                            <?php echo ($params['orderBy'] === 'nombre' && $params['orderDir'] === 'ASC') ? 'selected' : ''; ?>>
                            Nombre: A-Z</option>
                        <option value="nombre-DESC"
                            <?php echo ($params['orderBy'] === 'nombre' && $params['orderDir'] === 'DESC') ? 'selected' : ''; ?>>
                            Nombre: Z-A</option>
                    </select>
                </div>
            </div>
                ...
                <div class="products-grid" id="products-grid">
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            ...
                            <img src="data:image/jpeg;base64,<?php echo base64_encode($animal['foto']); ?>"
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-details">
                                ...
                                <p class="product-price"><?php echo number_format($animal['precio'], 2, ',', '.'); ?> €
                                </p>
                            </div>
